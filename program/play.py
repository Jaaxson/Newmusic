...
@Client.on_message(command(["play", f"play@{BOT_USERNAME}", "شغل", "جاكسون شغل", "تشغيل", "جاكسون", "جاك", "مودي", "محمد"]) & other_filters)
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("• قـنـأة ألـسـوُرس", url=f"https://t.me/J_X_S3"),
                  ],[
    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("💭 قـنـاة الـسـورس", url=f"https://t.me/J_X_S3")
                        ],
                        [
